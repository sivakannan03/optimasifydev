  ...
  <xsl:template match="/">
    <div id="tableContainer">
      <table align="center" width="100%" cellspacing="1" cellpadding="0" class="inner_tb"  border="1">
        ...
        <tr  align="center">
          <td class="tb-r2" width="15%">RBM's</td>
            ...
            <xsl:for-each select="//row[@Element='pso']">
              ...
              <xsl:if test ="count(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]) &gt; 0">
                <tr  align="left">
                  ...
                  <td align="right" >
                    <xsl:value-of select="sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@TPVisit)" />
                  </td>
                  <td align="right" >
                    <xsl:value-of select="sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v0)" />
                  </td>
                  <td align="right" >
                    <xsl:value-of select="sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v1)" />
                  </td>
        ...
        <td align="left">
          ...
          <a class="link1">
            <xsl:attribute name="href">
              javascript:showReport('<xsl:value-of select="@PSO"/>',' <xsl:value-of select="@Ename" />')
            </xsl:attribute>
            <xsl:value-of select="@Ename" />
          </a>
        </td>
