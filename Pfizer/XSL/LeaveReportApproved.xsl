...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <div id="Div_container">
      <table id="tblLeaveApproved" align="left" cellspacing="1" cellpadding="0"  class="inner_tb"  border="1" width="100%">
        <thead>
          <tr  class="tableheader">
            <th colspan="12">Approved</th>
          </tr>
          <tr class="tableheader">
            ...
            <th width="95px">App Date</th>
            <th align="center" width="100px">Reason</th>
          </tr>
        </thead>
        <xsl:choose>
          <xsl:when test="count(//row[@Element='APPROVED']) &gt; 0">
            <xsl:for-each select="//row[@Element='APPROVED']">
              ...
              <tr>
                ...
                <td>
                  <xsl:value-of select="@AppRejDate"/>
                </td>
                <td>
              ...
              <!--
								<tr class="tablecontent2">
									...
									<td><xsl:value-of select="@LeaveGenName"/></td>
									<td><xsl:value-of select="@Leaveavailed"/></td>
									<td><xsl:value-of select="@LeaveBalance"/></td>
									<td><xsl:value-of select="@OnProcess"/></td>
