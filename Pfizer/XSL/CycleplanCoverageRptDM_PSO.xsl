				...
				<xsl:when test="count(//row[@Element='Cycle_Pso']) &gt;0">
					<xsl:for-each select="//row[@Element='pso']">	
						...
						<tr  align="left">
							...
							<td align="right" class="tb-r1"><xsl:value-of select="sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@TPVisit)" /></td>
							<td align="right" class="tb-r1"><xsl:value-of select="sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v0)" /></td>
							<td align="right" class="tb-r1"><xsl:value-of select="sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v1)" /></td>
							<!--<td align="right"><xsl:value-of select="format-number(sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v2),'##,##,###','Infinity-format')" /></td>
							<td align="right"><xsl:value-of select="format-number(sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v3),'##,##,###','Infinity-format')" /></td>
							...
							<td align="right" class="heading2">
								<xsl:value-of select="(sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v2)*2) " />
							</td>
							<td align="right" class="heading2">
								<xsl:value-of select="(sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v3)*3) " />
							</td>
							<!-- Cov% Total
							<td align="right">
								<xsl:value-of select="format-number(((sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v1)+sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v2)+sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@v3)) div sum(//row[@Element='Cycle_Pso' and @PSO=$PSOFKID]/@TPVisit))*100,'##,##,###.##','Infinity-format')" />
							</td>-->
							<!-- Cov% Total new -->
							<td align="right" class="heading2">
