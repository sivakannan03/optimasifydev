 ...
 */
	...
	,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
		...
		,	togglerLength_open:		17			// Length = WIDTH of toggler button on north/south edges - HEIGHT on east/west edges
		,	togglerLength_closed: 	17		// 100% OR -1 means 'full height/width of resizer bar' - 0 means 'hidden'
	...
	var effects = { // LIST *PREDEFINED EFFECTS* HERE, even if effect has no settings
		slide:	{
			all:	{ duration:650} // eg: duration: 1000, easing: "easeOutBounce"
		,	north:	{ direction: "up"	}
